...
class Archivos extends Validator
{
    ...
    */
    ...
    {
        $punto = '.';
        $sql = 'SELECT arc.nombre_original,emp.nombre_empresa,fol.nombre_folder,arc.fecha_subida,arc.tamano,split_part(arc.nombre_archivo,?,2) AS tipo
                ...
                WHERE arc.fk_id_folder = ? AND arc.fk_id_estado !=3';
